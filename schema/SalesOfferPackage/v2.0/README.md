...
| `distributions` | no | $ref: https://schema.nfh.global/CommunicationChannel/v2.0/attributes.yaml#/components/schemas/CommunicationChannel | Channels through which this package can be purchased |
